                ...
                <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col justify-center mt-2">
                            <p className="text-white font-bold">Meghana A B</p>
                            <p className="mb-4 text-xs text-white">Full Stack Developer</p>
                            <p className="text-sm tracking-wide text-white">
                                I'm a computer science student with a focus on DevOps and Full Stack development. I've contributed to various projects. Connect with me for innovative solutions in web development.
                            </p>
                        </div>
                    </div>
                    <div>
